...
class ClothingCategoryList extends Component {

    render() {
      const { clothing_data, navigate } = this.props;
      
        return (
            <FlatList
        data={clothing_data}
        renderItem={({ item }) => (
          <ClothingCategoryCell item = { item } navigate = { navigate }/>
        )}
...
class ClothingCategoryCell extends Component {
    ...
    render() {
      ...
      <TouchableOpacity
      key= {item.id}
      onPress={() => navigate('ClothingDetail', {item: item})}>
...
export default class ClothingCategory extends Component {

    
    render() {
      const { category, items } = this.props.route.params;
...
Array.prototype.remove = function(from, to) {
  ...
  const DATA_DUMMY = [
    ...
    uri: 'data:image/jpeg;base64,',
      ...
      name: {
          brand: 'Uniqlo',
          style: "Woman's Draper Jogger Pants",
          full_name: "Uniqlo Woman's Draper Jogger Pants"
      },
      category: 'Pants',
      purchase_price: '$36.00',
      purchase_date: '03/19/2016',
