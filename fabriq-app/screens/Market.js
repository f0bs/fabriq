...
export default class Market extends Component {
  ...
  render() {
    ...
    return (
        ...
        {/* always says unrecognized font family 'material icons' */}
            {/* <SearchBar
            ...
            <View style = {styles.title_container}>
                <Text style = {styles.title_main}> Marketplace </Text>
            </View>
            <View style = {styles.subtitle_container}>
                <Text style = {styles.subtitle_style}> New Items </Text>
            </View>
            <FlatList horizontal
            ...
            <View>
                <Card
                    image = {
                        {
                            uri: 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/jeans-scattered-on-a-wooden-background-royalty-free-image-940015420-1551972989.jpg'
                        }
                    }
                    imageStyle = {styles.image}
                    containerStyle={ styles.card_large }
                    >
                    <View style = {styles.catogry_info}>
                        < Text style = {styles.catogory_title} >
                        Men 's Jeans
                        </Text>
                        < Text style = {styles.buy_icon} >
                            Shop now
                        </Text>
                    </View>
                </Card> 
